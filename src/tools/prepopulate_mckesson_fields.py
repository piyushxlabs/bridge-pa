...
SCHEMA = {
    "name": "prepopulate_mckesson_fields",
    "description": "Auto-generated schema for prepopulate_mckesson_fields"
}

class PrepopulateMckessonFieldsParams(BaseModel):
...
async def execute(params: dict) -> dict:
    ...
    endpoint = os.getenv(f"API_ENDPOINT_PREPOPULATE_MCKESSON_FIELDS", f"http://localhost:8080/prepopulate_mckesson_fields")
    try:
